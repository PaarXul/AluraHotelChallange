...
public class ReservasView extends JFrame {
	...
	public ReservasView() {
		...
		txtFechaS.addPropertyChangeListener(new PropertyChangeListener() {
			public void propertyChange(PropertyChangeEvent evt) {
				calcularValorReserva(txtFechaE,txtFechaS);
			}
		});
		...
		btnsiguiente.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				if (ReservasView.txtFechaE.getDate() != null && ReservasView.txtFechaS.getDate() != null) {
          			guardarReserva();
					RegistroHuesped registro = new RegistroHuesped(nreserva);
    ...
    try {
		...
		nreserva = reservasController.guardar(reserva);
	...
	private void calcularValorReserva(JDateChooser fechaE, JDateChooser fechaS){
		...
		if(fechaE.getDate()!= null && fechaS.getDate() !=null){
			...
			if(inicio.before(fin) || inicio.equals(fin)){
				...
				JOptionPane.showMessageDialog(contentPane, "Error: " + "Favor de ingresar una fecha valida", "Fechas anterior a la de entrada", JOptionPane.ERROR_MESSAGE);
			}
			valor = dias * diaria;
