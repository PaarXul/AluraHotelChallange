...
public class RegistroHuesped extends JFrame {
	 ...
	 * Create the frame.
	 */
	public RegistroHuesped(int nreserva) {
		...
		btnguardar.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseClicked(MouseEvent e) {
				//aqui tiene que ir el metodo
				guardarRegistroHuesped();
			}
		});
	...
	public void guardarRegistroHuesped(){

		try {
			String nombreH = txtNombre.getText();
			String apellidoH = txtApellido.getText();
			String fechaNaciH = ((JTextField) txtFechaN.getDateEditor().getUiComponent()).getText();
			String nacionalidadH = txtNacionalidad.getSelectedItem().toString();
			String telefonoH = txtTelefono.getText();
			int nReservaH = Integer.parseInt(txtNreserva.getText());

			if(!fechaNaciH.equals("") && !nombreH.equals("") && !apellidoH.equals("") && !nacionalidadH.equals("") && !telefonoH.equals("") ) {

				Huesped huesped = new Huesped(nombreH, apellidoH, java.sql.Date.valueOf(fechaNaciH), nacionalidadH, telefonoH, nReservaH);
